...
import com.example.think.emulatebd.adapter.RecentAdapter;
...
import com.example.think.emulatebd.fragment.LeftFragment;
import com.example.think.emulatebd.fragment.RightFragment;
import com.example.think.emulatebd.pullrefresh.PullToRefreshBase;
import com.example.think.emulatebd.slidingmenu.BaseSlidingFragmentActivity;
import com.example.think.emulatebd.slidingmenu.SlidingMenu;
import com.example.think.emulatebd.swipelistview.BaseSwipeListViewListener;
...
public class MainActivity extends BaseSlidingFragmentActivity implements
        View.OnClickListener, PushMessageReceiver.EventHandler,
        HomeWatcher.OnHomePressedListener, PullToRefreshBase.OnPullEventListener{
    ...
    private void initRecentData() {
        ...
        mAdapter = new RecentAdapter(this, mRecentListView, mRecentDatas);
    ...
    public void onNewFriend(User u) {
        android.os.Message handlerMsg = handler.obtainMessage(NEW_FRIEND);
        handlerMsg.obj = u;
        handler.sendMessage(handlerMsg);
    }
