...
public class CustomViewBehind extends ViewGroup{
    ...
    private SlidingMenu.CanvasTransformers mTransformer;
    ...
    public void setCanvasTransformer(SlidingMenu.CanvasTransformers t) {
        mTransformer = t;
    }
    ...
    public void setMode(int mode){
        if (mode == SlidingMenu.LEFT || mode == SlidingMenu.RIGHT){
            ...
            if (mSecondaryContent != null){
                mSecondaryContent.setVisibility(VISIBLE);
            }
        }
        mMode = mode;
    }
    ...
    public boolean matginTouchAllowed(View content, int x){
    ...
    public void drawSelector(View content, Canvas canvas, float openPercent){
        if (!mSelectorEnabled)
            return;
        if (mShadowDrawable != null && mSelectedView != null){
